package com.kay.apiconsumer.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<UUID, TransactionMessage> consumerFactory(){
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE,"com.kay.apiconsumer.models.TransactionMessage");
    ...
    //ConcurrentMessageListenerContainer - for multithreading
